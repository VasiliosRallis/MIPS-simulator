...
int32_t addu(State& mips_state,int32_t& source1_field,int32_t& source2_field){
	int32_t  rs = mips_state.reg[source1_field];
	int32_t  rt = mips_state.reg[source2_field];
	return  rs+rt ;
}
...
int32_t srl(State& mips_state,int32_t& source2_field,int32_t shamt_field){
...
int32_t subu(State& mips_state,int32_t& source1_field,int32_t& source2_field){
	int32_t rs = mips_state.reg[source1_field];
	int32_t rt = mips_state.reg[source2_field];
	return  rs-rt ;
}
